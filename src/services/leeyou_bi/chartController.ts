...
/** genChartByAiAsync POST /api/Chart/uploadAsync */
export async function genChartByAiAsyncUsingPost(
  ...
  return request<API.BaseResponseBIResponse_>('/api/Chart/uploadAsync', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsyncByMq POST /api/Chart/uploadAsync/mq */
export async function genChartByAiAsyncByMqUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByAiAsyncByMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBIResponse_>('/api/Chart/uploadAsync/mq', {
    method: 'POST',
    params: {
      ...params,
    },
